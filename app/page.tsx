        ...
        {!isOpen ? (
          ...
          >
            ...
            <motion.button
              ...
              className="group relative flex w-full max-w-sm flex-col items-center overflow-hidden rounded-[2.5rem] border-2 border-amber-400/50 bg-gradient-to-b from-[#FAF8F5] via-[#F3ECE3] to-[#E2D2C0] p-8 text-center shadow-[0_35px_90px_rgba(217,119,6,0.25)] transition-all duration-500 hover:border-amber-300 cursor-pointer"
            >
          ...
          /* =========================================================
             VISTA 2: TARJETA INTERNA ANIMADA CON OSITO ASOMÁNDOSE
             ========================================================= */
          <motion.main
            key="invitation-view"
            ...
            className="relative z-10 flex min-h-[890px] w-full max-w-md flex-col items-center overflow-y-visible border-2 border-amber-400/50 bg-[#FDFBF7] px-6 py-8 shadow-[0_30px_100px_rgba(217,119,6,0.3)] md:rounded-[2.8rem] my-10"
          >
            ...
            <button
              ...
              className="self-end z-20 rounded-full bg-amber-100/80 px-4 py-1 text-[10px] font-bold tracking-widest uppercase text-amber-900 transition-all hover:bg-amber-200 hover:scale-105 active:scale-95 shadow-sm cursor-pointer"
            >
              ✕ Cerrar Sobre
            </button>
