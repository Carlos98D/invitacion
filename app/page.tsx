      ...
      <AnimatePresence mode="wait">
        {!isOpen ? (
          ...
          >
            ...
            >
              <div className="relative w-52 h-44 md:w-60 md:h-52 flex items-center justify-center drop-shadow-md">
                <Image 
                  src="/oso.png" 
                  ...
                  priority
                />
                <div className="absolute inset-x-0 top-[42%] flex flex-col items-center justify-center px-6 pt-1 pointer-events-none text-center">
                  <span className="font-serif italic font-extrabold text-lg md:text-xl tracking-wide bg-gradient-to-r from-amber-950 via-amber-800 to-amber-950 bg-clip-text text-transparent drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)] leading-tight">
                    Merari
                  </span>
                  <span className="font-serif italic font-extrabold text-lg md:text-xl tracking-wide bg-gradient-to-r from-amber-950 via-amber-800 to-amber-950 bg-clip-text text-transparent drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)] leading-tight mt-0.5">
                    Catalina
                  </span>
                </div>
              </div>
